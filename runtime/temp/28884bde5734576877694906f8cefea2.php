<?php /*a:2:{s:77:"/www/wwwroot/education.kedaweilai.com/application/admin/view/good/update.html";i:1575449982;s:79:"/www/wwwroot/education.kedaweilai.com/application/admin/view/public/header.html";i:1575443563;}*/ ?>
<!doctype html>
...
<div class="x-nav" id="app">
    ...
    <a class="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right;margin-right: 15px;"
       onclick="location.href='<?php echo url('ls'); ?>'" title="返回商品列表">
...
<form class="layui-form layui-form-pane form" action="" lay-filter="update">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            ...
            <div style="margin-top:15px;" id="simple_img">
                <a href="<?php echo htmlentities($sel['img']); ?>" target="_blank"><img src="<?php echo htmlentities($sel['img']); ?>" class="layui-upload-img" width="190px"
                                                          height="148px"></a>
            </div>
            <?php else: ?>
        ...
        <div class="layui-input-inline" style="width: 70%">
            ...
            <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 10px;">
                ...
                <div class="layui-upload-list" id="preview">
                    <?php if($sel['thumb']): foreach($sel['thumb'] as $item): ?>
    ...
    <div class="layui-form-item" style="text-align: center">
        <div class="layui-btn " style="width: 100px;height: 40px;line-height: 40px"
             onclick="location.href='<?php echo url('ls'); ?>'">返回商品列表
        </div>
...
<script>
    ...
    var form = layui.form
        ...
        layedit.setContent(index, '<?php echo $sel['content']; ?>');
        ...
        form.val('update', {
            ...
            "img": "<?php echo htmlentities($sel['img']); ?>", // "name": "value"
            "thumb": "<?php echo htmlentities($sel['thumbs']); ?>", // "name": "value"
