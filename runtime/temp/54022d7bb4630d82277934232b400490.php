<?php /*a:2:{s:78:"/www/wwwroot/education.kedaweilai.com/application/admin/view/good/type_ls.html";i:1575449982;s:79:"/www/wwwroot/education.kedaweilai.com/application/admin/view/Public/header.html";i:1575443563;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加商品分类','<?php echo url('add_type'); ?>',450,330)"><i class="layui-icon"></i>添加商品分类</button>
                </div>
                <div class="layui-card-body ">
