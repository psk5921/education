<?php /*a:2:{s:77:"/www/wwwroot/education.kedaweilai.com/application/admin/view/role/update.html";i:1573029103;s:79:"/www/wwwroot/education.kedaweilai.com/application/admin/view/public/header.html";i:1572258006;}*/ ?>
<!doctype html>
<html class="x-admin-sm">
<head>
    <meta charset="UTF-8">
    <title>角色编辑</title>
    <meta name="keywords" content="角色编辑" />
...
<script>
    layui.use(['form'], function(){
        ...
        //表单初始赋值
          form.val('update', {
              "name": "<?php echo htmlentities($role['name']); ?>", // "name": "value"
              "id": "<?php echo htmlentities($role['id']); ?>" // "name": "value"
          })
