<?php /*a:2:{s:77:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp\application\admin\view\teacher\ls.html";i:1571707856;s:80:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp\application\admin\view\Public\header.html";i:1571656120;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加教师','<?php echo url('add'); ?>',400,500)"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body ">
