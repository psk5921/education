<?php /*a:2:{s:85:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\clbum\add_class.html";i:1571795141;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\public\header.html";i:1571656122;}*/ ?>
<!doctype html>
<html class="x-admin-sm">
<head>
    <meta charset="UTF-8">
    <title>班级添加</title>
    <meta name="keywords" content="班级添加" />
...
<form class="layui-form layui-form-pane form" action="" lay-filter="add">
    <div class="layui-form-item">
        <label class="layui-form-label">班级名称 <span class="x-red">*</span></label>
    ...
    <div class="layui-form-item">
        <label for="username" class="layui-form-label">
            <span class="x-red">*</span>班级对应的课程</label>
        <div class="layui-input-inline">
            <select id="cid" name="cid" class="valid">
                 <?php if(is_array($couse) || $couse instanceof \think\Collection || $couse instanceof \think\Paginator): $i = 0; $__LIST__ = $couse;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
    ...
    <div class="layui-form-item">
        <label for="username" class="layui-form-label">
            <span class="x-red">*</span>删除状态</label>
        <div class="layui-input-inline">
