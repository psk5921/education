<?php /*a:2:{s:80:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp\application\admin\view\index\welcome.html";i:1571656120;s:80:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp\application\admin\view\Public\header.html";i:1571656120;}*/ ?>
<!doctype html>
            ...
            <div class="layui-card">
                ...
                <div class="layui-card-body ">
                    <table class="layui-table">
                        ...
                        <tr>
                            <th>上传文件最大限制</th>
                            <td>{{max_file_uploads}}</td></tr>
                        <tr>
                            <th>执行时间限制</th>
                            <td>{{max_execution_time}}</td></tr>
                        <tr>
                            <th>已使用内存</th>
                            <td>{{memory_usage}}</td></tr>
                        </tbody>
                    </table>
                </div>
            </div>
                ...
                <div class="layui-card-body ">
                    <table class="layui-table">
                        ...
                        <tr>
                            <th>版权所有</th>
                            <td>
                                <a :href="server_name" target="_blank" class="x-red">科大未来</a></td>
                        </tr>
                        <tr>
                            <th>开发者</th>
                            <td>科大未来开发团队</td></tr>
