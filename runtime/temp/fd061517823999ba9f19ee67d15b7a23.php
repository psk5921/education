<?php /*a:2:{s:78:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp\application\admin\view\category\ls.html";i:1571709605;s:80:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp\application\admin\view\Public\header.html";i:1571656120;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <script type="text/html" id="category_teacher">
                    <a href="<?php echo url('teacher_ls'); ?>" class="layui-table-link">课程老师</a>
                </script>
        ...
        table.render({
            ...
            ,cols: [
                [ //表头
                    ...
                    ,{field: 'teacher_name', title: '课程老师', templet: '#category_teacher',align:'center'}
