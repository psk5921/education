<?php /*a:2:{s:89:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\order\shop_order_ls.html";i:1571917259;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\Public\header.html";i:1571656122;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加商品','<?php echo url('shop_order_add'); ?>',550,650)"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body ">
...
<script>
    ...
    layui.use(['table'], function(){
        ...
        table.render({
            elem: '#order'
            ,url: "<?php echo url('shop_order_ls'); ?>" //数据接口
            ,page: true //开启分页
            ,cols: [
                [ //表头
                    ...
                    ,{field: 'total', title: '商品总数量'}
                    /*,{field: 'img', title: '商品封面', minWidth: 150, align: "center",templet:function(d){
                        var img="<img src='"+d.img+"' style='width:30px;height:30px;' />";
                        return img;
                    },align: "center"}*/
                    ,{field: 'price', title: '订单总价格'}
                    ,{field: 'fee', title: '运费'}
                    ,{field: 'is_invite', title: '是否自取'}
                    ,{field: 'status', title: '支付状态'}
                    ,{field: 'is_evaluate', title: '是否自取'}
                    ,{field: 'createtime', title: '创建时间'}
                    ,{field: 'paytime', title: '付款时间'}
                    ,{field: 'deliver_time', title: '发货时间'}
                    ,{field: 'finish_time', title: '完成时间'}
                    ,{field: 'express_no', title: '物流单号'}
                    ,{field: 'express_name', title: '物流名称'}
                    ,{field: 'cancel_time', title: '取消时间'}
                    ,{field: 'is_reminder', title: '是否催单'}
