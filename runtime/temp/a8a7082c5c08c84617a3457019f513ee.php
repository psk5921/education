<?php /*a:2:{s:86:"/www/wwwroot/education.kedaweilai.com/application/admin/view/teacher/talk_teacher.html";i:1573051756;s:79:"/www/wwwroot/education.kedaweilai.com/application/admin/view/public/header.html";i:1572258006;}*/ ?>
<!doctype html>
<html class="x-admin-sm">
<head>
    <meta charset="UTF-8">
    <title>会员评价教师</title>
    <meta name="keywords" content="会员评价教师" />
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
               <!-- <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加评论','<?php echo url('talk_add'); ?>?id=<?php echo htmlentities($teacher_id); ?>',500)"><i class="layui-icon"></i>添加</button>
                </div>-->
                 <div class="layui-card-header">
                    <button class="layui-btn"   onclick="location.href='<?php echo url('ls'); ?>'">返回列表</button>
                </div>
                <div class="layui-card-body ">
                    <table id="Tteacher" lay-filter="Tteacher"></table>
                </div>
...
<script>
    ...
    layui.use(['table'], function(){
        ...
        table.render({
            ...
            ,url: "<?php echo url('talk_teacher'); ?>?teacher_id="+<?php echo htmlentities($teacher_id); ?>
            ,page: true //开启分页
            ,cols: [[ //表头
        ...
        //监听工具条
        table.on('tool(Tteacher)', function(obj){
            var data = obj.data;
            if(obj.event === 'edit'){
                var url = "<?php echo url('talk_update'); ?>?id="+data.id+'&teacher_id='+<?php echo htmlentities($teacher_id); ?>;
                xadmin.open('编辑教师评价',url,500,500)
            }else if(obj.event === 'del'){
                layer.confirm('确认要删除评价吗？操作不可逆哦！！',{title:'系统提示'}, function(index){
                    $.ajax({
                        type: "post",
                        url: "<?php echo url('talk_del'); ?>",
                        dataType: "json",
