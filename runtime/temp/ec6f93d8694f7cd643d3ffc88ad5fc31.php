<?php /*a:2:{s:85:"/www/wwwroot/education.kedaweilai.com/application/admin/view/order/shop_order_ls.html";i:1575449602;s:79:"/www/wwwroot/education.kedaweilai.com/application/admin/view/public/header.html";i:1575443563;}*/ ?>
<!doctype html>
...
<script>
    ...
    layui.use(['table'], function(){
        ...
        table.on('tool(order)', function(obj){
            var data = obj.data;
            if(obj.event === 'view'){
                var url = "<?php echo url('shop_detail'); ?>?id="+data.id;
