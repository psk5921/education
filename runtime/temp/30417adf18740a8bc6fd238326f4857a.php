<?php /*a:2:{s:78:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\clbum\ls.html";i:1571970128;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\Public\header.html";i:1571656122;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加课程分类','<?php echo url('add_class'); ?>',400,500)"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body ">
                    <table id="class" lay-filter="class"></table>
                </div>
                <script type="text/html" id="barDemo">
                    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="taocan">套餐</a>
                    <a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
                    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del">删除</a>
                    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="time">课程时间</a>
                </script>
            </div>
        </div>
    </div>
    ...
    layui.use(['table'], function(){
        ...
        table.on('tool(class)', function(obj){
            ...
            if(obj.event === 'edit'){
                ...
                var url = "<?php echo url('package_list'); ?>?id="+data.id;
                xadmin.open('班级套餐列表',url,1000,600)
            }else if(obj.event === 'time'){
                var url = "<?php echo url('class_time'); ?>?id="+data.id;
                xadmin.open('班级套餐列表',url,1000,600)
            }
        });
