<?php /*a:2:{s:80:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\package\ls.html";i:1571707468;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\Public\header.html";i:1571656122;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加套餐','<?php echo url('add'); ?>',400,500)"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body ">
        ...
        table.render({
            ...
            ,cols: [
                [ //表头
                    ...
                    ,{field: 'package_time', title: '可使用次数'}
                    ,{field: 'package_month', title: '可使用多少月'}
