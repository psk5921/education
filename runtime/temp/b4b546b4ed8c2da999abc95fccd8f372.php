<?php /*a:2:{s:88:"/www/wwwroot/education.kedaweilai.com/application/admin/view/package/package_update.html";i:1572951428;s:79:"/www/wwwroot/education.kedaweilai.com/application/admin/view/public/header.html";i:1572258006;}*/ ?>
<!doctype html>
...
<form class="layui-form layui-form-pane form" action="" lay-filter="update">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <select id="class_id" name="class_id" class="valid">
                ...
                <option value="<?php echo htmlentities($vo['id']); ?>"><?php echo htmlentities($vo['class_name']); ?></option>
...
<script>
    ...
    layui.use(['form'], function(){
        ...
        form.val('update', {
            ...
            "class_id": "<?php echo htmlentities($sel['class_id']); ?>", // "name": "value"
