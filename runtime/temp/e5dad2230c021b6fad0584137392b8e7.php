<?php /*a:2:{s:76:"/www/wwwroot/education.kedaweilai.com/application/admin/view/package/ls.html";i:1572951209;s:79:"/www/wwwroot/education.kedaweilai.com/application/admin/view/Public/header.html";i:1572258006;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加套餐','<?php echo url('package_add'); ?>',460,500)"><i class="layui-icon"></i>添加套餐</button>
                </div>
                <div class="layui-card-body ">
...
<script>
    ...
    layui.use(['table'], function(){
        ...
        table.render({
            ...
            ,cols: [
                [ //表头
                    ...
                    ,{field: 'package_month', title: '有效期',align:"center"}
        ...
        table.on('tool(package)', function(obj){
            var data = obj.data;
            if(obj.event === 'edit'){
                var url = "<?php echo url('package_update'); ?>?id="+data.id;
                xadmin.open('编辑套餐',url,460,500)
            }else if(obj.event === 'del'){
                layer.confirm('确认要删除该套餐吗？操作不可逆哦！！',{title:'系统提示'}, function(index){
                    $.ajax({
                        type: "post",
                        url: "<?php echo url('package_delete'); ?>",
                        dataType: "json",
                        data:{id:data.id},
