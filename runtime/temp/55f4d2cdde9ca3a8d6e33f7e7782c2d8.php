<?php /*a:2:{s:74:"/www/wwwroot/education.kedaweilai.com/application/admin/view/clbum/ls.html";i:1575449925;s:79:"/www/wwwroot/education.kedaweilai.com/application/admin/view/Public/header.html";i:1575443563;}*/ ?>
<!doctype html>
...
-->
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加班级','<?php echo url('add_class'); ?>',450,350)"><i class="layui-icon"></i>添加班级</button>
                </div>
                <div class="layui-card-body ">
    ...
    layui.use(['table'], function(){
        ...
        table.on('tool(class)', function(obj){
            ...
            if(obj.event === 'edit'){
                ...
                var url = "<?php echo url('package_list'); ?>?class_id="+data.id;
                location.href = url;
            }else if(obj.event === 'time'){
                var url = "<?php echo url('class_time'); ?>?class_id="+data.id;
                location.href = url;
            }
        });
