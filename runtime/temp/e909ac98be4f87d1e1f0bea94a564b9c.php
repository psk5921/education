<?php /*a:2:{s:76:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\vip\ls.html";i:1571968989;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\Public\header.html";i:1571656122;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <script type="text/html" id="barDemo">
                    <a class="layui-btn layui-btn-xs" lay-event="address">家庭住址</a>
                    <a class="layui-btn layui-btn-xs" lay-event="baby">宝宝</a>
        ...
        table.render({
            ...
            ,cols: [
                [ //表头
                    ...
                    /*  ,{field: 'avatar', title: '头像', minWidth: 150, align: "center",templet:function(d){
                              var img="<img src='"+d.avatar+"' style='width:30px;height:30px;' />";
                              return img;
                          },align: "center"}*/
                    ,{field: 'gender', title: '性别',width:100,}

                    ,{field: 'credit', title: '会员积分',width:100}
                    ,{field: 'createtime', title: '创建时间',width:120}
                    ,{field: 'identity', title: '会员身份标识' ,templet: '#vip_v1',width:100}
