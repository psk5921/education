<?php /*a:2:{s:91:"/www/wwwroot/education.kedaweilai.com/application/admin/view/user_program/program_list.html";i:1575450267;s:79:"/www/wwwroot/education.kedaweilai.com/application/admin/view/public/header.html";i:1575443563;}*/ ?>
<!doctype html>
<html class="x-admin-sm">
<head>
    <meta charset="UTF-8">
    <title>会员课程</title>
    <meta name="keywords" content="会员课程" />
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加会员课程','<?php echo url('add'); ?>',400,500)"><i class="layui-icon"></i>添加会员课程</button>
                </div>
                <div class="layui-card-body ">
