<?php /*a:2:{s:77:"/www/wwwroot/education.kedaweilai.com/application/admin/view/category/ls.html";i:1575449821;s:79:"/www/wwwroot/education.kedaweilai.com/application/admin/view/Public/header.html";i:1575443563;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="location.href='<?php echo url('course_add'); ?>'"><i class="layui-icon"></i>添加课程</button>
                </div>
                <div class="layui-card-body ">
...
<script>
    ...
    layui.use(['table'], function(){
        ...
        table.on('tool(category)', function(obj){
            var data = obj.data;
            if(obj.event === 'edit'){
                var url = "<?php echo url('course_update'); ?>?id="+data.id;
                location.href = url;
                ...
                layer.confirm('确认要删除该课程吗？操作不可逆哦！！',{title:'系统提示'}, function(index){
                    $.ajax({
                        type: "post",
                        url: "<?php echo url('course_delete'); ?>",
                        dataType: "json",
                        data:{id:data.id},
