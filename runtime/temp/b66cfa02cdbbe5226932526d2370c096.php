<?php /*a:2:{s:80:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\perm\index.html";i:1571656122;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\Public\header.html";i:1571656122;}*/ ?>
<!doctype html>
            ...
            <div class="layui-card">
               <!-- <div class="layui-card-body ">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加菜单','<?php echo url('add'); ?>',400,500)"><i class="layui-icon"></i>添加</button>
    ...
    layui.use(['table'], function(){
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'sortnum', title: '排序',edit:'text'}
