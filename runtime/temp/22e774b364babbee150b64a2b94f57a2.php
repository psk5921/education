<?php /*a:2:{s:77:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\good\ls.html";i:1571909579;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\Public\header.html";i:1571656122;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加商品','<?php echo url('add'); ?>',550,650)"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body ">
        ...
        table.render({
            ...
            ,cols: [
                [ //表头
                    ...
                    ,{field: 'short_title', title: '商品短标题'}
                    ,{field: 'shop_category_name', title: '商品分类'}
                    ...
                    ,{field: 'thumb', title: '商品轮播图'}
                    ,{field: 'content', title: '商品内容'}
