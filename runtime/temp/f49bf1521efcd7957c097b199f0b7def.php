<?php /*a:2:{s:78:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\good\add.html";i:1571909105;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\public\header.html";i:1571656122;}*/ ?>
<!doctype html>
...
<form class="layui-form layui-form-pane form" action="" lay-filter="add">
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">商品短标题 <span class="x-red">*</span></label>
        <div class="layui-input-inline">
            <input type="text" name="short_title" lay-verify="required" placeholder="请输入商品短标题" autocomplete="off" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        <label class="layui-form-label">商品内容 <span class="x-red">*</span></label>
        <div class="layui-input-inline">
            <input type="text" name="content" lay-verify="required" placeholder="请输入商品内容" autocomplete="off" class="layui-input">
