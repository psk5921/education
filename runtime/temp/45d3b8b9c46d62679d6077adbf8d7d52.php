<?php /*a:2:{s:88:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\clbum\package_list.html";i:1571812614;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\public\header.html";i:1571656122;}*/ ?>
<!doctype html>
...
<script>
    ...
    layui.use(['table'], function(){
        ...
        table.render({
            ...
            ,url: "<?php echo url('package_list'); ?>?id="+<?php echo htmlentities($id); ?>
            ,page: true //开启分页
            ,cols: [[ //表头
                ...
                ,{field: 'package_time', title: '使用次数',align: "center"}
                ,{field: 'package_month', title: '可使用多少月',align: "center"}
