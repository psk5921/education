<?php /*a:2:{s:86:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\clbum\class_time.html";i:1571816082;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\public\header.html";i:1571656122;}*/ ?>
<!doctype html>
<html class="x-admin-sm">
<head>
    <meta charset="UTF-8">
    <title>班级套餐</title>
    <meta name="keywords" content="班级套餐" />
...
<script>
    ...
    layui.use(['table'], function(){
        ...
        table.render({
            ...
            ,url: "<?php echo url('class_time'); ?>?id="+<?php echo htmlentities($id); ?>
            ,page: true //开启分页
            ,cols: [[ //表头
                ...
                ,{field: 'week_start', title: '课程开始的星期',align: "center"}
                ,{field: 'week_end', title: '课程结束的星期',align: "center"}
                ,{field: 'week_type', title: '课程时间类型',align: "center"}
                ,{field: 'time_start_h', title: '开始时',align: "center"}
                ,{field: 'time_start_m', title: '开始分',align: "center"}
                ,{field: 'time_end_h', title: '结束时',align: "center"}
                ,{field: 'time_end_m', title: '结束分',align: "center"}
