<?php /*a:2:{s:80:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\user\index.html";i:1571656122;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\Public\header.html";i:1571656122;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" onclick="xadmin.open('添加管理员','<?php echo url('add'); ?>',400,500)"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body ">
    ...
    layui.use(['table'], function(){
        ...
        table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'role_id', title: '角色身份'}
                ,{field: 'createtime', title: '添加时间'}
                ,{field: 'logintime', title: '上一次登录时间'}
                ,{field: 'loginip', title: '上一次登录IP',width:130}
