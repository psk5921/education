<?php /*a:2:{s:86:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\category\type_ls.html";i:1571792661;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\Public\header.html";i:1571656122;}*/ ?>
<!doctype html>
            ...
            <div class="layui-card">
                <div class="layui-card-body ">
                    <form class="layui-form layui-col-space5" id="searchs">
                        ...
                        <div class="layui-inline layui-show-xs-block">
                            <input type="text" name="edu_category_name" id="edu_category_name" placeholder="请输入课程分类中文名字" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-inline layui-show-xs-block">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加课程分类','<?php echo url('add_type'); ?>',400,350)"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body ">
        ...
        table.render({
            ...
            ,cols: [
                [ //表头
                    ...
                    ,{field: 'edu_category_en_name', title: '课程分类英文名'}
                    ,{field: 'edu_category_name', title: '课程分类中文名'}
