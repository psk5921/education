<?php /*a:2:{s:82:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\good\type_ls.html";i:1571896062;s:83:"F:\phpStudy\PHPTutorial\WWW\yyzj_weapp_v1\application\admin\view\Public\header.html";i:1571656122;}*/ ?>
<!doctype html>
        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    <button class="layui-btn" id="add_vip"  onclick="xadmin.open('添加商品分类','<?php echo url('add_type'); ?>',400,350)"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body ">
...
<script>
    ...
    layui.use(['table'], function(){
        ...
        table.render({
            ...
            ,cols: [
                [ //表头
                    ...
                    ,{field: 'shop_category_name', title: '商品名称'}
        ...
        table.on('tool(goodtype)', function(obj){
            var data = obj.data;
            if(obj.event === 'edit'){
                var url = "<?php echo url('update_type'); ?>?id="+data.id;
